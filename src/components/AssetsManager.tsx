                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between sm:justify-end gap-3.5">
                        ...
                        <div className="flex items-center gap-1 opacity-75 hover:opacity-100 group-hover:opacity-100 transition-all border-l border-ink/5 pl-2 relative z-10 shrink-0">
                          <button 
